...
public class TestHospitalAdmissionMedicalServiceMedicalTestDataServiceEJBArq2 {
	private static Logger logger = Logger.getLogger(TestHospitalAdmissionMedicalServiceMedicalTestDataServiceEJBArq2.class.getName());
